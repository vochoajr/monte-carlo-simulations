...
def makePlots():
	...
	fig_x2.text(-0.5, 1.0, "mean = " +str(mean_e2))
	fig_x2.text(-0.5, 0.75, "std = " +str(stddev_e2))
	...
	#y = mlab.normpdf( binEdges, mean_e2, stddev_e2)
	#l = fig_x2.plot(binEdges, y, 'g', linewidth=2)
	
	binHeight, binEdges, patches = fig_x3.hist(listx_e3,nBins,normed=True)
	fig_x3.set_title("N = " + str(N_e3))
	fig_x3.text(-0.5, 0.9, "mean = " +str(mean_e3))
	fig_x3.text(-0.5, 0.7, "std = " +str(stddev_e3))
	fig_x3.text(-0.5, 0.5, "efficiency = " +str(efficiency_e3))
	...
	#y = mlab.normpdf( binEdges, mean_e3, stddev_e3)
	#l = fig_x3.plot(binEdges, y, 'g', linewidth=2)
